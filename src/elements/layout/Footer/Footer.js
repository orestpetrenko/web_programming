    ...
    return <Container fluid as='footer' className="border-top border-dark px-lg-5">
        <Row className="justify-content-stretch mx-lg-5 py-3 border-bottom border-dark flex-column flex-md-row">
            <Col>
                ...
                We are a company with great ambitions. Our garage has the best prices on the market. So, buy our cars. Please
        ...
        <p className="text-center text-muted py-3">2024 &#169;Copyright all rights reserved</p>
    </Container>
}
